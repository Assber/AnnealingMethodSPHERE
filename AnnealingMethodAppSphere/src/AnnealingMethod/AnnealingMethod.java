...
class AnnealingMethod extends JFrame implements ActionListener {
    ...
    static JTextField xProvidedValue;
    static JLabel xProvidedValueLabel;
    ...
    static JTextField xIntervalPercent;
    static JLabel xIntervalPercentLabel;
    ...
    static JTextField xIntervalStep;
    static JLabel xIntervalStepLabel;
    ...
    public static void main(String args[]) {
        ...
        xProvidedValue = new JTextField(16);
        xProvidedValue.setEditable(true);
        xProvidedValueLabel = new JLabel("x - Пункт(предоставленное значение):");
        
        rIntervalPercent = new JTextField(16);
        rIntervalPercent.setEditable(true);
        rIntervalPercentLabel = new JLabel("Погрешность изменения для r(Радиус):");

        pIntervalPercent = new JTextField(16);
        pIntervalPercent.setEditable(true);
        pIntervalPercentLabel = new JLabel("Погрешность изменения для p(Плотность):");

        hIntervalPercent = new JTextField(16);
        hIntervalPercent.setEditable(true);
        hIntervalPercentLabel = new JLabel("Погрешность изменения для h(Глубина):");

        xIntervalPercent = new JTextField(16);
        xIntervalPercent.setEditable(true);
        xIntervalPercentLabel = new JLabel("Погрешность изменения для x(Пункт):");
        ...
        xIntervalStep = new JTextField(16);
        xIntervalStep.setEditable(true);
        xIntervalStepLabel = new JLabel("Шаг в интервале, для x(пункт):");
        ...
        p.add(xProvidedValueLabel);
        p.add(xProvidedValue);
        ...
        p.add(xIntervalPercentLabel);
        p.add(xIntervalPercent);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            String simulatedAnnealingResult = simulatedAnnealing.startCalc(Double.parseDouble(rProvidedValue.getText()),
                    ...
                    Double.parseDouble(xProvidedValue.getText()),Double.parseDouble(xIntervalPercent.getText()), 
                    Double.parseDouble(xIntervalStep.getText()));
